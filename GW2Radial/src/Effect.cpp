...
void HandleFailedShaderCompile(HRESULT hr, ID3DBlob* errors) {
    ...
    if (hr == 0x88760b59)
        ...
        CriticalMessageBox(L"Fatal error: shader compilation failed! Error code was 0x%X. Please report this to https://github.com/gw2-addon-loader/GW2Radial/issues", hr);
#endif
